...
chrome.contextMenus.onClicked.addListener(function (info, tab) {
  var target = info.linkUrl; // https://www.bilibili.com/video/BV1gM411W7ex/?p=1
  // 使用正则表达式提取视频p参数

  var p = target.match(/p=\d+/)[0].match(/\d+/)[0];
  var bv = target.match(/BV\w+/)[0];
